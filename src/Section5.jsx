            ...
            <section className="flex gap-5">
                <div className="flex border-r pr-5 w-160 border-gray-300 wrap-break-word">
                    ...
                    <ul className="flex-col ml-8 mt-18">
                        ...
                        <li className="mt-4"><p className="text-sm">🎙️ Podcast Episode: Meet Pastor Mario - Reformation in India 🇮🇳 Join us for an awesome episode as we sit …</p></li>
                ...
                <div className="wrap-break-word w-80">
                    <div className="flex gap-5.5 mb-3.5">
                        ...
                        <div className="flex flex-col">
                            <p className="font-semibold text-[22px] leading-6 pb-4">Concerned about The Coalition (Par<span className="text-sm">...</span></p>
                            <p className="font-bold flex flex-row gap-3 hover:text-[#9c3466]">Play Episode <FaRegArrowAltCircleRight size={20} className="mt-1" /></p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-5.5 mb-3.5">
                        ...
                        <div className="flex flex-col">
                            <p className="font-semibold text-[22px] leading-6 pb-4">Podcast - COVID, the Cross & the En<span className="text-sm">...</span></p>
                            <p className="font-bold flex flex-row gap-3 hover:text-[#9c3466]">Play Episode <FaRegArrowAltCircleRight size={20} className="mt-1" /></p>
                        </div>
                    </div>
                    <hr className="mb-3.5 text-gray-200" />
                    <div className="flex gap-5.5 mb-3.5">
                        ...
                        <div className="flex flex-col">
                            <p className="font-semibold text-[22px] leading-6 pb-4">Podcast - Apologetics, the<span className="text-sm">...</span></p>
                            <p className="font-bold flex flex-row gap-3 hover:text-[#9c3466]">Play Episode <FaRegArrowAltCircleRight size={20} className="mt-1" /></p>
                        </div>
                    </div>
                </div>
                <div className="border-7 w-70 border-gray-300 wrap-break-word">
                    <p className="text-xs font-semibold tracking-wider whitespace-break-spaces ml-5 mt-7">COMING SOON - DEC 2022</p>
                    ...
                    <p className="text-lg mx-5 mt-3">The Annual Cross Purpose Magazine</p>
                </div>
            </section>
        </div>
    )
